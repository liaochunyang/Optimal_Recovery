...
% Here we produce Figure 1 in the main text.

%% Load a small graph
clear all;clc;
load smallgraphs/adjnounA.mat
rng(5)      % comment out this line to produce different plots
...
for i=1:length(range_nl)
    ...
    for j=1:Monte
        ...
        % Global OR: using overestimated eta
